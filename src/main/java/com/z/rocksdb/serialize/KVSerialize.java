package com.z.rocksdb.serialize;

import com.z.rocksdb.exception.DeserializationException;
import com.z.rocksdb.exception.SerializationException;

/**
 * @author <a href=mailto:someharder@gmail.com>yinyu</a> 2021/1/20
 */
public interface KVSerialize<T> {
